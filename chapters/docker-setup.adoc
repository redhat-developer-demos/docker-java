...
Download Vagrant from http://classroom.example.com:8082/downloads/virtualbox/ and install.
...
TODO Setup the insecure registry
...
### JBoss Developer Studio 9 - CR1

To install JBoss Developer Studio stand-alone, complete the following steps:

. Download http://classroom.example.com:8082/downloads/jboss-devstudio-9.0.0.CR1-v20150911-1025-B3967-installer-standalone.jar[9.0.0 CR1].
