...
Download https://devstudio.redhat.com/9.0/snapshots/builds/devstudio.product_master/latest/all/jboss-devstudio-9.0.0.CR1-v20150911-1025-B3967-installer-standalone.jar[JBoss Developer Studio 9.0 - CR1 - 490MB - JAR File] and place it inside `dockerfiles/lab-httpd-server/downloads` folder.
